...
class YoutubeDownloaderApp:
    ...
    def start_download(self) -> None:
        ...
        self.download_thread = threading.Thread(
            ...
            args=(self.current_info["webpage_url"], format_choice.format_id, output_dir),
            daemon=True,
        )
    ...
    def _download_thread(self, url: str, format_id: str, output_dir: str) -> None:
        def progress_hook(data: Dict) -> None:
            ...
            if status == "downloading":
                ...
                self.info_queue.put(("progress", {"percent": 100.0}))
        ...
        try:
            ...
            self.info_queue.put(("done", "Download abgeschlossen."))
    ...
    def _update_info(self, info: Dict) -> None:
        ...
        self._populate_format_choices(info)
        self.status_var.set("Informationen geladen. Wähle ein Format aus.")
